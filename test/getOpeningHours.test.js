...
describe('Testes da função getOpeningHours', () => {
  ...
  it('Testa se não passando argumentos retornar um objeto com todos os dias e horários', () => {
  ...
  it('Testa se para os argumentos Monday e 09:00-AM deve retornar a string "The zoo is closed"',
    () => { expect(getOpeningHours('Monday', '09:00-AM')).toBe('The zoo is closed'); });
  it('testa se para os argumentos Tuesday e 09:00-AM deve retornar a string "The zoo is open"',
    () => { expect(getOpeningHours('Tuesday', '09:00-AM')).toBe('The zoo is open'); });
  it('testa se para os argumentos Wednesday e 09:00-PM deve retornar a string "The zoo is closed"',
  ...
  it('Para os argumentos Thu e 09:00-AM deve lançar uma exceção com a mensagem: "The day must be valid. Example: Monday"', () => {
    expect(() => getOpeningHours('09:00-AM')).toThrow('The day must be valid. Example: Monday');
  });
